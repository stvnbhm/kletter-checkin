                    ...
                    <div class="bg-white border border-gray-200 rounded-xl p-4 shadow-sm space-y-3
                        ...
                        <div class="flex items-start justify-between gap-3">
                            ...
                            <div class="flex flex-col items-end gap-1 shrink-0">
                                ...
                                {{-- Zusatztext nur bei orange/red --}}
                                @if ($registration->access_reason && in_array($registration->access_status, ['orange', 'red']))
                                    <span class="text-xs text-gray-400 text-right">{{ $registration->access_reason }}</span>
                                @endif
                            </div>
                        </div>
                        ...
                        @if ($registration->needs_supervision || $registration->needs_parent_consent)
                            <div class="text-xs text-gray-600 space-y-1 border-t border-gray-100 pt-2">
                                @if ($registration->needs_supervision)
                                    <div>Unter 14 – Aufsicht nötig
                                        @if ($registration->supervision_confirmed)
                    ...
                    <table class="w-full text-left">
                        <thead class="bg-gray-50 border-b border-gray-200">
                            <tr>
                                ...
                                <th class="px-4 py-3 text-xs font-bold text-gray-500 uppercase tracking-wider">Typ</th>
                                ...
                                <th class="px-4 py-3 text-xs font-bold text-gray-500 uppercase tracking-wider">Minderjährige</th>
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            @forelse ($registrations as $registration)
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-4 align-top text-sm text-gray-600">
                                        @if ($registration->needs_supervision)
                                            <div>Unter 14 – Aufsicht nötig</div>
                                            <div class="text-xs text-gray-400 mt-0.5">
                                                @if ($registration->supervision_confirmed)
                                                    Aufsicht bestätigt
                                                @else
                                                    Aufsichtsperson muss anwesend sein
                                                @endif
                                            </div>
                                        @endif

                                        @if ($registration->needs_parent_consent)
                                            <div class="{{ $registration->needs_supervision ? 'mt-2' : '' }}">
...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <title>Registrierungsbestätigung | Kletterhalle</title>
